...
public class CategoryEndpoints : IEndpointGroup
{
    ...
    public static async Task<Ok<CategoryDto>> GetCategoryById(ISender sender, Guid id)
    {
    ...
    public static async Task<Results<NoContent, BadRequest>> UpdateCategory(ISender sender, Guid id,
    ...
    public static async Task<NoContent> DeleteCategory(ISender sender, Guid id)
    {
